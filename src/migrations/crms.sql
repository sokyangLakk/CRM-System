...
CREATE TABLE `classes` (
  ...
  `generation` enum('junior','senior') NOT NULL,
...
INSERT INTO `classes` (`id`, `name`, `generation`, `advisor_id`, `created_at`) VALUES
(1, 'A', 'junior', 1, '2026-06-01 03:53:52'),
(2, 'B', 'junior', 2, '2026-06-01 03:53:52'),
(3, 'C', 'senior', 3, '2026-06-01 03:53:52');
...
CREATE TABLE `cleaning_assignments` (
  ...
  `status` enum('assigned','done','missed') DEFAULT 'assigned',
...
(1, 1, 1, 1, 'done', 10, '2026-06-01 03:53:52'),
(2, 1, 2, 2, 'done', 10, '2026-06-01 03:53:52'),
(3, 1, 3, 3, 'done', 10, '2026-06-01 03:53:52'),
(4, 2, 4, 4, 'done', 10, '2026-06-01 03:53:52'),
(5, 2, 5, 5, 'done', 10, '2026-06-01 03:53:52'),
(6, 2, 6, 7, 'missed', 0, '2026-06-01 03:53:52'),
(7, 3, 7, 6, 'done', 10, '2026-06-01 03:53:52'),
(8, 3, 8, 8, 'done', 10, '2026-06-01 03:53:52'),
(9, 3, 9, 9, 'done', 10, '2026-06-01 03:53:52'),
(10, 4, 1, 10, 'done', 10, '2026-06-01 03:53:52'),
(11, 4, 2, 11, 'done', 10, '2026-06-01 03:53:52'),
(12, 4, 3, 2, 'done', 10, '2026-06-01 03:53:52'),
(13, 5, 4, 1, 'assigned', 0, '2026-06-01 03:53:52'),
(14, 5, 5, 3, 'assigned', 0, '2026-06-01 03:53:52'),
(15, 5, 6, 4, 'assigned', 0, '2026-06-01 03:53:52'),
(16, 6, 7, 5, 'assigned', 0, '2026-06-01 03:53:52'),
(17, 6, 8, 6, 'assigned', 0, '2026-06-01 03:53:52'),
(18, 6, 9, 7, 'assigned', 0, '2026-06-01 03:53:52'),
(19, 7, 6, 12, 'assigned', 0, '2026-06-01 03:53:52');
...
CREATE TABLE `cleaning_schedules` (
  ...
  `day_type` enum('normal','wednesday','punishment') NOT NULL,
...
INSERT INTO `cleaning_schedules` (`id`, `schedule_date`, `day_type`, `class_id`, `teacher_id`, `description`, `status`, `created_at`) VALUES
(1, '2026-05-25', 'normal', 1, 1, 'Regular Monday cleaning — Class A', 'completed', '2026-06-01 03:53:52'),
(2, '2026-05-26', 'normal', 2, 2, 'Regular Tuesday cleaning — Class B', 'completed', '2026-06-01 03:53:52'),
(3, '2026-05-27', 'wednesday', 3, 3, 'Wednesday deep-clean — Class C', 'completed', '2026-06-01 03:53:52'),
(4, '2026-05-28', 'normal', 1, 1, 'Regular Thursday cleaning — Class A', 'completed', '2026-06-01 03:53:52'),
(5, '2026-05-29', 'normal', 2, 2, 'Regular Friday cleaning — Class B', 'pending', '2026-06-01 03:53:52'),
(6, '2026-06-01', 'normal', 3, 3, 'Regular Monday cleaning — Class C', 'pending', '2026-06-01 03:53:52'),
(7, '2026-06-02', 'punishment', 1, 1, 'Punishment schedule after incident 2026-05-29', 'pending', '2026-06-01 03:53:52');
...
CREATE TABLE `cleaning_tasks` (
  ...
  `type` enum('normal','punishment') NOT NULL,
  `description` text DEFAULT NULL,
...
INSERT INTO `cleaning_tasks` (`id`, `name`, `type`, `description`, `points`, `max_students`, `created_at`) VALUES
(1, 'Water flowers (garden)', 'normal', 'Water all plants in the front garden area.', 10, 1, '2026-06-01 03:53:52'),
(2, 'Clean yard', 'normal', 'Sweep and collect rubbish from the school yard.', 10, 1, '2026-06-01 03:53:52'),
(3, 'Boy WC ground floor', 'normal', 'Clean and mop the ground floor boys toilet.', 10, 1, '2026-06-01 03:53:52'),
(4, 'Girl WC ground floor', 'normal', 'Clean and mop the ground floor girls toilet.', 10, 1, '2026-06-01 03:53:52'),
(5, 'Boy WC first floor', 'normal', 'Clean and mop the first floor boys toilet.', 10, 1, '2026-06-01 03:53:52'),
(6, 'Girl WC first floor', 'normal', 'Clean and mop the first floor girls toilet.', 10, 1, '2026-06-01 03:53:52'),
(7, 'Clean ground floor', 'normal', 'Sweep and mop all ground floor corridors.', 10, 1, '2026-06-01 03:53:52'),
(8, 'B05 room cleaning', 'normal', 'Sweep, mop, and tidy classroom B05.', 10, 1, '2026-06-01 03:53:52'),
(9, 'Water filter area cleaning', 'normal', 'Wipe down water filter stations and surrounding area.', 10, 1, '2026-06-01 03:53:52'),
(10, 'B32 room cleaning', 'normal', 'Sweep, mop, and tidy classroom B32.', 10, 1, '2026-06-01 03:53:52'),
(11, 'Storage room floor cleaning', 'normal', 'Sweep and mop the storage room floor.', 10, 1, '2026-06-01 03:53:52'),
(12, 'Prepare washing plate area', 'punishment', 'Set up and clean the plate-washing area after lunch.', 5, 1, '2026-06-01 03:53:52');
...
INSERT INTO `punishment_records` (`id`, `student_id`, `task_id`, `teacher_id`, `reason`, `start_date`, `end_date`, `points_deducted`, `status`, `created_at`) VALUES
(1, 6, 12, 2, 'Failed to complete assigned cleaning duty on 2026-05-26 without valid reason.', '2026-06-02', '2026-06-04', 15, 'active', '2026-06-01 03:53:52'),
(2, 9, 12, 1, 'Repeated absence from cleaning schedule during May.', '2026-05-20', '2026-05-22', 15, 'completed', '2026-06-01 03:53:52');
...
(10, 14, 'Vannda Meas', 'STU-010', 1, 'male', 'vannda@students.crms.local', '011-111-010', 'inactive', '2026-06-01 03:53:52');
...
INSERT INTO `teachers` (`id`, `user_id`, `name`, `department`, `phone`, `created_at`) VALUES
(1, 2, 'Mr. Chan Dara', 'Mathematics', '012-345-678', '2026-06-01 03:53:52'),
(2, 3, 'Ms. Sopha Lim', 'Science', '017-234-567', '2026-06-01 03:53:52'),
(3, 4, 'Mr. Borey Khem', 'Khmer', '010-987-654', '2026-06-01 03:53:52');
...
(14, 'svannda', 'student123', 'vannda@students.crms.local', 'student', 'inactive', '2026-06-01 03:53:52', '2026-06-01 03:53:52');
...
--
ALTER TABLE `cleaning_schedules`
  ADD CONSTRAINT `cleaning_schedules_ibfk_1` FOREIGN KEY (`class_id`) REFERENCES `classes` (`id`),
  ADD CONSTRAINT `cleaning_schedules_ibfk_2` FOREIGN KEY (`teacher_id`) REFERENCES `teachers` (`id`);

--
-- Constraints for table `punishment_records`
--
ALTER TABLE `punishment_records`
  ADD CONSTRAINT `punishment_records_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`),
  ADD CONSTRAINT `punishment_records_ibfk_2` FOREIGN KEY (`task_id`) REFERENCES `cleaning_tasks` (`id`),
  ADD CONSTRAINT `punishment_records_ibfk_3` FOREIGN KEY (`teacher_id`) REFERENCES `teachers` (`id`);
