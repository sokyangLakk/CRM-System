...
export class ReportRepository {
  ...
  static async getClassReportStudents(classId: number): Promise<any[]> {
  ...
  static async getStudentCleaningReport(studentId: number): Promise<any> {
  ...
  static async getStudentPunishmentReport(studentId: number): Promise<any> {
