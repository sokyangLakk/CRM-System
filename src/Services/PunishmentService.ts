...
export class PunishmentService {
  static async issuePunishmentService(data: { student_id: number; offense: string; punishment_type: string; points_deducted?: number }, editorRole?: string, editorUserId?: number, ipAddress?: string): Promise<number> {
  ...
  static async resolvePunishmentService(recordId: number, status: 'completed' | 'appealed', editorUserId?: number, ipAddress?: string): Promise<boolean> {
  ...
  static async resolvePunishment(recordId: number, status: 'completed' | 'appealed'): Promise<boolean> {
