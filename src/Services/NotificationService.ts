export class NotificationService {
   ...
   */
  static async sendNotification(recipientEmail: string, subject: string, message: string): Promise<boolean> {
  ...
  static async notifyStudentAssignment(studentName: string, studentEmail: string, taskName: string, date: string): Promise<void> {
  ...
  static async notifyStudentPunishment(studentName: string, studentEmail: string, offense: string, punishment: string, points: number): Promise<void> {
